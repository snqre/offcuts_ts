...
export type NavSignUpFormSignUpAction = (username: string, password: string, email: string) => Promise<[success: boolean, message: string | null]>;

export type NavSignUpFormValidateAction = (username: string, password: string, email: string) => Promise<[success: boolean, message: string]>;
